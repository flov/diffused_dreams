...
export const prompts = (descriptor: string): Prompt[] => [
  ...
  {
    label: "Pirate",
    prompt: `a portrait of a ${descriptor} pirate in a ship in a stormy sea, lighthouse in the background by raphael lacoste`,
    negativePrompt: "nsfw, naked, nude",
    flowID: descriptor === "two persons" ? 37 : 31,
    image: "/images/pirate.png",
  },
  {
    label: "Van Gogh",
    prompt: `full body painting portrait of a ${descriptor} in starry night by van gogh , fantasy landscap, style of van gogh starry night`,
    negativePrompt: "nsfw, naked, nude",
    flowID: descriptor === "two persons" ? 37 : 31,
